...
import com.bzu.yhd.pocketcampus.main.SplashActivity;
...
public final class ActivityUtil {
    ...
    public static void show(final Context context, final String message) {
        final String msg=msgFilter != null ? msgFilter.filter(message) : message;
        BaseApplication.getInstance().getTopActivity().runOnUiThread(new Runnable() {

            public void run() {
                // Toast.makeText(activity, msg, Toast.LENGTH_SHORT).show();
                Toast toast=ToastFactory.getToast(BaseApplication.getInstance().getTopActivity(), message);
    ...
    public static void addShortCut(Context context) {
        ...
        ShortcutIconResource resource= ShortcutIconResource.fromContext(context, R.mipmap.ic_launcher);
