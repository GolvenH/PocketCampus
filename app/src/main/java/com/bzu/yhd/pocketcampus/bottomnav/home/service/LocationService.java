...
public class LocationService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        PLog.w("LocationService", "================ onStart ===============");
    ...
    private LocationListener mLocationListener = new LocationListener() {
        ...
        public void onLocationChanged(Location location) {
            ...
            mSubscriber = new ApiSubscriber<NetLocResult>() {
                ...
                public void onNext(NetLocResult netLocResult) {
                    ...
                    if (netLocResult.getUpperCity() != null && !netLocResult.getUpperCity().isEmpty()) {
                        ...
                        PLog.i("LocationService", "------------定位成功：" + netLocResult.getUpperCity() + "，" + newCity);
                        ...
                        if (diffUpper && !newCity.equals(PrefUtil.getCity())) {
                            ...
                            PLog.w("LocationService", "-----------------sendBroadcast locate succeed-----------------");
                        }
                    }
            ...
            PLog.i("LocationService", "------------ 原生经纬度：" + location.getLatitude() + "," + location.getLongitude());
            double[] latLng = WGS84ToGCJ02(location.getLatitude(), location.getLongitude());
            PLog.i("LocationService", "---------- 转换后经纬度：" + latLng[0] + "," + latLng[1]);
    ...
    public void onDestroy() {
        super.onDestroy();
        PLog.w("LocationService", "=============== onDestroy ==============");
    }
