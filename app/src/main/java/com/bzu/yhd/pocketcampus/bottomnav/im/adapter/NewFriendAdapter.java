...
import com.bzu.yhd.pocketcampus.bottomnav.im.adapter.base.BaseRecyclerAdapter;
import com.bzu.yhd.pocketcampus.bottomnav.im.adapter.base.BaseRecyclerHolder;
...
public class NewFriendAdapter extends BaseRecyclerAdapter<NewFriend> {
    ...
    public void bindView(final BaseRecyclerHolder holder, final NewFriend add, int position)
    {
        ...
        PLog.i("bindData:" + status + "," + add.getUid() + "," + add.getTime());
