package com.bzu.yhd.pocketcampus.bottomnav.home.daohang;
...
public class BNMainActivity extends Activity {
	...
	private void routeplanToNavi(CoordinateType coType) {
		...
		switch (coType) {
			...
			case BD09LL: {
				sNode = new BNRoutePlanNode(117.9447191468,37.3766746866, "滨州市汽车总站", null, coType);
				eNode = new BNRoutePlanNode(117.9912110229, 37.3865795478, "滨州学院南门", null, coType);
				break;
			}
			default:
				;
